    ...
    return (
        <SafeAreaView className="flex-1 bg-background">
            ...
            <View className="px-2 py-2 h-25 flex-row items-center">
                ...
                <Text className="text-2xl ml-3 color-foreground">Scan Account ID QR Code</Text>
            </View>
            ...
            <ScrollView className="m-2 flex-grow">
                ...
                {permission?.granted !== true && (
                    <View>
                        ...
                        <Text className="text-center text-sm">
                            Sonalyze does not have permission to access the camera.
                        </Text>
                ...
                <View className="mb-3 items-center">
                    ...
                    {permission?.granted === true && (
                        <View className="mx-10 items-center">
                            <Text className="mb-3 text-center text-base font-medium">
                                Scan the QR code from your other devices to transfer your account to this device:
                            </Text>
                            <TouchableOpacity className="justify-center flex-row items-center px-3 py-2 rounded-lg bg-primary" onPress={() => { }}>
                                <Icon name="scan-qr-code" />
                                <Text className="pl-1 text-sm">Scan QR Code</Text>
                            </TouchableOpacity>
                    ...
                    <TouchableOpacity className="justify-center flex-row items-center px-3 py-2 rounded-lg bg-primary" onPress={async () => {
                        ...
                        <Text className="pl-1 text-sm">Paste from Clipboard</Text>
                    </TouchableOpacity>
                </View>

                <Text className="text-center text-sm">
                    After scanning, your rooms and measurement history will be accessible on this device.
                    Alternatively, you can paste your Account ID from clipboard and handle the distribution manually.
                </Text>
            </ScrollView>
